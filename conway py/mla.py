# -*- coding: utf-8 -*-
"""
Created on Sun Feb 14 18:19:55 2016
...
class hillClimb:
    ...
    def mla(self, fitness, pool): # nAverage = number of trials to average to evaluate fitness.
        # Tries a new pattern. Picks it if better.

        nAverage = self.replicates
        Score = self.multiTrial(pool)
